...
using Catalog.Infrastructure.EntityConfiguartions;
...
namespace Catalog.Infrastructure.DataContext
{
    public class CatalogDbContext : DbContext, IDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new CatalogItemEntityTypeConfiguartion());
            modelBuilder.ApplyConfiguration(new CatalogTypeEntityTypeConfiguration());

            modelBuilder.Entity<CatalogType>().HasData(GetCatalogTypes());

            modelBuilder.Entity<CatalogBrand>().HasData(GetCatalogBrands());

            modelBuilder.Entity<CatalogItem>().HasData(GetCatalogItems());
    ...
    public class CatalogDbContextDesignFactory : IDesignTimeDbContextFactory<CatalogDbContext>
    {
        public CatalogDbContext CreateDbContext(string[] args)
        {
            var optionBuilder = new DbContextOptionsBuilder<CatalogDbContext>()
                .UseSqlServer("Server=localhost;Database=CatalogDb;User Id=sa;Password=ThyThy@20082021;");
